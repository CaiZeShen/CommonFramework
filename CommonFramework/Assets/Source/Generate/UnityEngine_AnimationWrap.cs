...
public class UnityEngine_AnimationWrap
{
	...
	static int Stop(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes<UnityEngine.Animation>(L, 1))
			{
	...
	static int Play(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Animation, UnityEngine.PlayMode>(L, 1))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Animation, string, UnityEngine.PlayMode>(L, 1))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
	...
	static int Blend(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Animation, string, float, float>(L, 1))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int CrossFadeQueued(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Animation, string, float, UnityEngine.QueueMode>(L, 1))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Animation, string, float, UnityEngine.QueueMode, UnityEngine.PlayMode>(L, 1))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int AddClip(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Animation, UnityEngine.AnimationClip, string>(L, 1))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Animation, UnityEngine.AnimationClip, string, int, int>(L, 1))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				UnityEngine.AnimationClip arg0 = (UnityEngine.AnimationClip)ToLua.ToObject(L, 2);
				string arg1 = ToLua.ToString(L, 3);
			...
			else if (count == 6 && TypeChecker.CheckTypes<UnityEngine.Animation, UnityEngine.AnimationClip, string, int, int, bool>(L, 1))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				UnityEngine.AnimationClip arg0 = (UnityEngine.AnimationClip)ToLua.ToObject(L, 2);
				string arg1 = ToLua.ToString(L, 3);
	...
	static int RemoveClip(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Animation, UnityEngine.AnimationClip>(L, 1))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				UnityEngine.AnimationClip arg0 = (UnityEngine.AnimationClip)ToLua.ToObject(L, 2);
				obj.RemoveClip(arg0);
