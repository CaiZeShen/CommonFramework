...
public class UnityEngine_AudioClipWrap
{
	...
	static int Create(IntPtr L)
	{
		try
		{
			...
			if (count == 5 && TypeChecker.CheckTypes<string, int, int, int, bool>(L, 1))
			{
			...
			else if (count == 6 && TypeChecker.CheckTypes<string, int, int, int, bool, UnityEngine.AudioClip.PCMReaderCallback>(L, 1))
			{
				string arg0 = ToLua.ToString(L, 1);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg2 = (int)LuaDLL.lua_tonumber(L, 3);
				...
				else
				{
					...
					arg5 = (UnityEngine.AudioClip.PCMReaderCallback)DelegateTraits<UnityEngine.AudioClip.PCMReaderCallback>.Create(func);
				}
			...
			else if (count == 7 && TypeChecker.CheckTypes<string, int, int, int, bool, UnityEngine.AudioClip.PCMReaderCallback, UnityEngine.AudioClip.PCMSetPositionCallback>(L, 1))
			{
				string arg0 = ToLua.ToString(L, 1);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg2 = (int)LuaDLL.lua_tonumber(L, 3);
				...
				else
				{
					...
					arg6 = (UnityEngine.AudioClip.PCMSetPositionCallback)DelegateTraits<UnityEngine.AudioClip.PCMSetPositionCallback>.Create(func);
				}
