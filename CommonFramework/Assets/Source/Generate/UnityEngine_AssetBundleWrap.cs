...
public class UnityEngine_AssetBundleWrap
{
	...
	static int LoadFromFileAsync(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<string, uint, ulong>(L, 1))
			{
				string arg0 = ToLua.ToString(L, 1);
				uint arg1 = (uint)LuaDLL.lua_tonumber(L, 2);
	...
	static int LoadAsset(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.AssetBundle, string>(L, 1))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.AssetBundle, string, System.Type>(L, 1))
			{
				UnityEngine.AssetBundle obj = (UnityEngine.AssetBundle)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
	...
	static int LoadAllAssets(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.AssetBundle, System.Type>(L, 1))
			{
				UnityEngine.AssetBundle obj = (UnityEngine.AssetBundle)ToLua.ToObject(L, 1);
